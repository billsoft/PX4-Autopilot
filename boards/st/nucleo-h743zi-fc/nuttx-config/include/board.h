...
#ifndef __BOARDS_ST_NUCLEO_H743ZI_FC_FC_NUTTX_CONFIG_INCLUDE_BOARD_H
#define __BOARDS_ST_NUCLEO_H743ZI_FC_FC_NUTTX_CONFIG_INCLUDE_BOARD_H
...
/* SYSCLK = PLL1P = 480 MHz (PX4 Configuration)
...
/* I2C1 Use Nucleo I2C1 pins (CubeMX Master Mode Configuration) */
...
/* SPI1 - ICM42688P IMU1 (CubeMX Master Mode Configuration)
 * IMPORTANT: Using CubeMX actual pin configuration
 */
...
/* SPI3 - ICM42688P IMU2 (CubeMX Master Mode Configuration)
 * IMPORTANT: Using CubeMX actual pin configuration
 */
