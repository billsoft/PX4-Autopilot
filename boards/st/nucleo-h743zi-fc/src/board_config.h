...
/* CMOS同步输入（行/帧）GPIO：按硬件文档选择可用引脚，默认使用PE11/PE9 */
#define GPIO_CMOS_SYNC_LINE   (GPIO_INPUT|GPIO_PULLUP|GPIO_PORTE|GPIO_PIN11)
#define GPIO_CMOS_SYNC_FRAME  (GPIO_INPUT|GPIO_PULLUP|GPIO_PORTE|GPIO_PIN9)
