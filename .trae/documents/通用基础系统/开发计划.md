...
- 入口与覆盖：`ROMFS/px4fmu_common/init.d/rcS:124-131`（优先执行 `/fs/microsd/etc/rc.txt`）
- 传感器启动：`ROMFS/px4fmu_common/init.d/rcS:322-366` + `rc.sensors`
- 估计器选择：`ROMFS/px4fmu_common/init.d/rcS:369-385`
- MAVLink 与串口：`ROMFS/px4fmu_common/init.d/rcS:504-523`；串口生成器 `Tools/serial/generate_config.py`
- Pixhawk 6X 目标：`boards/px4/fmu-v6x/`；构建 `make px4_fmu-v6x_default`
- RTCM 注入链：`src/modules/mavlink/mavlink_receiver.cpp:2603-2620`；驱动处理 `src/drivers/gps/devices/src/gps_helper.h:288-297`、`src/drivers/gnss/septentrio/septentrio.cpp:352`
